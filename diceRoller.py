...
def request():
    confirm = 0
    while confirm != "Y" or "Y6" or "YT"::
        confirm = input("Enter 'Y' to roll the dice\n'Y6' to roll the dice until it rolls a 6\nor 'YT' to roll the dice until it rolls the same number twice in a row >>> ")
...
def run6(): #This function rolls the dice until it rolls a 6, and then stops.
    while roll != 6:
        run()
        if roll == 6:
            break
